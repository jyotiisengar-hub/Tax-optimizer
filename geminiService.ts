...
export const getBehavioralProfile = async (transactions: Transaction[]): Promise<BehavioralProfile | null> => {
  ...
  const systemInstruction = `
    ...
    4. Generate a short, insightful narrative (2-3 sentences) explaining the user's overall financial personality, explicitly mentioning the names of the dominant archetype(s) identified. Wrap the names of the archetypes in <u> tags to underline them (e.g., <u>Impulse Spender</u>).
